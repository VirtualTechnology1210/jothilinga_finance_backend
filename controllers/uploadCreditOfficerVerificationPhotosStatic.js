...
const uploadCreditOfficerVerificationPhotosStatic = async (req, res) => {
  try {
    ...
    uploadPhotos.fields([
      ...
      try {
        ...
        // Retrieve the existing credit_officer_verification_photos_static record, if any
        ...
        // Save or update the credit_officer_verification_photos_static record
        await credit_officer_verification_photos_static.upsert({
          memberId: member_id,
          description,
          comment,
          ...photoData,
        ...
        res.status(201).json({
          message: "credit_officer_verification_photos uploaded successfully",
          memberId: member_id,
        });
      } catch (error) {
...
module.exports = uploadCreditOfficerVerificationPhotosStatic;
