...
module.exports = updateMemberContactDetails = async (req, res) => {
  ...
  try {
    ...
    if (memberDetails) {
      ...
      if (memberDetails.latitude !== undefined) {
        updateData.latitude = memberDetails.latitude;
      }
      if (memberDetails.longitude !== undefined) {
        updateData.longitude = memberDetails.longitude;
      }
