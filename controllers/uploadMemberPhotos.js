...
const fs = require("fs");
const { member_photos, member_details } = require("../models"); // Adjust the import path as needed

const uploadMemberPhotos = async (req, res) => {
  try {
    ...
    uploadPhotos.fields([
      ...
      { name: "businessProofPhoto", maxCount: 1 },
      ...
      try {
        ...
        const existingRecord = await member_photos.findOne({
        ...
        // Save or update the member_photos record
        await member_photos.upsert({
          memberId: member_id,
          anotherIdentity,
          ...photoData,
        });
...
module.exports = uploadMemberPhotos;
