  ...
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.bulkInsert(
        ...
        [
          {
            reportName: "foreclosureReport",
            createdAt: new Date(),
            updatedAt: new Date(),
          },
          {
            reportName: "eucReport",
            createdAt: new Date(),
            updatedAt: new Date(),
          },
          {
            reportName: "croTransferByCenterWiseReport",
            createdAt: new Date(),
            updatedAt: new Date(),
          },
          {
            reportName: "croTransferByMemberWiseReport",
            createdAt: new Date(),
            updatedAt: new Date(),
          },
          {
            reportName: "processingFeeSummaryReport",
            createdAt: new Date(),
            updatedAt: new Date(),
          },
        ],
      ...
      const insertedReports = await queryInterface.sequelize.query(
        `SELECT id, reportName FROM reports WHERE reportName IN (
          'foreclosureReport',
          'eucReport',
          'croTransferByCenterWiseReport',
          'croTransferByMemberWiseReport',
          'processingFeeSummaryReport'          
        )`,
